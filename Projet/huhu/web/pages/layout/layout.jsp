        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="/Dao/tocrudutilisateurs.do" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i> utilisateurs</a><a href="/Dao/tocrudcommandes.do" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i> commandes</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
